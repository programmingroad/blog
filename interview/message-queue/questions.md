...
普通集群模式：
![alt](./images/rabbitmq普通集群模式.png)

镜像集群模式：
![alt](./images/rabbitmq镜像集群模式.png)

2. kafka高可用
![alt](./images/kafka高可用.png)

#### 如何保证消息不被重复消费？如何保证消息消费的幂等性？
![alt](./images/kafka消费端可能出现的重复消费问题.png)
...
1. rabbitmq可能存在的数据丢失
 ![alt](./images/rabbitmq可能存在的数据丢失问题.png)
 
2. kafka可能存在的数据丢失
 ![alt](./images/kafka数据丢失的场景.png)
